...
public class DirectoryFragment extends Fragment {
    ...
    EditText ed_search;
    String session_email, session_username,
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v_fragment = inflater.inflate(R.layout.fragment_directory, container, false);
    ...
    private void init(){
        ...
        List<Prospectus> prospectuses = Prospectus.listAll(Prospectus.class);
        ...
        if (prospectuses.size() > 0) {
            ...
            adapter = new AdapterProspectus(context);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context, OrientationHelper.VERTICAL, false);
            mRecyclerView = (RecyclerView) v_fragment.findViewById(R.id.recyclerView);
            mRecyclerView.setLayoutManager(linearLayoutManager);
            mRecyclerView.setItemAnimator(new DefaultItemAnimator());
